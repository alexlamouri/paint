...
public class PaintFileParserTest {
	...
	public void parserTest17() throws IOException {
		this.doParserTestCase("samplefiles/circle_fail_negcenter.txt",
				"Returns false for circle with negative center", "Error in line 5 ");
	}
	
	@Test
	public void parserTest18() throws IOException {
		this.doParserTestCase("samplefiles/circle_fail_negradius.txt",
				"Returns false for circle with negative radius", "Error in line 6 ");
	}
	
	@Test
	public void parserTest19() throws IOException {
		this.doParserTestCase("samplefiles/rectangle_fail_negpoints.txt",
				"Returns false for rectangle with negative points", "Error in line 5 ");
	}
	
	@Test
	public void parserTest20() throws IOException {
		this.doParserTestCase("samplefiles/squiggle_fail_negpoints.txt",
				"Returns false for squiggle with negative points", "Error in line 6 ");
	}
	
	@Test
	public void parserTest21() throws IOException {
		this.doParserTestCase("samplefiles/multishapes_leading0.txt",
				"Returns true for file with leadings 0s", "");
	}
